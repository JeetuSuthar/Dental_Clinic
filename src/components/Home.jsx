            ...
            <div className=" grid grid-cols-1 lg:grid-cols-3 items-center justify-items-center gap-4 py-6">
                <div className="flex flex-col items-center h-full w-full justify-center font-serif text-white item p-10  bg-indigo-800 rounded-3xl shadow-md">
                    ...
                    <p className="text-white pb-5">
                        We work on holidays, besides working late on regular days. In case of
                        emergencies we accept bookings.
                    </p>
                    <div to="/register" className=" border   text-white px-2 py-1 lg:px-4 lg:py-2 rounded-md hover:bg-white hover:text-black">
                        Chat with Doctor
                    </div>
                </div>
